    ...
    <>
      ...
      <div className="about-us-container">
        ...
        <p>
          ...
          professional and personal growth. We aim to provide resources,
          organize events, and create opportunities for our members to connect
          and collaborate.
        </p>
        <p>
          ...
          graduates to stay involved and contribute to the continuous
          development of the FDIBA community.
        </p>
        <p>
          Whether you're looking to reconnect with old friends, find new job
          opportunities, or give back to the university, the FDIBA Alumni
          Network is here to help you achieve your goals.
        </p>
        <h2>Our Values</h2>
